...
#define S_FUNCTION_NAME Solver_PumpPressureControl_simulinkBlockcompact
...
static void mdlInitializeSizes(SimStruct *S)
{
	...
	/* Input Port 3 */
    ssSetInputPortMatrixDimensions(S,  3, 16, 1);
	...
	/* Output Port 0 */
    ssSetOutputPortMatrixDimensions(S,  0, 48, 1);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
	...
	/* Simulink data */
	const Solver_PumpPressureControl_int *reinitialize = (const Solver_PumpPressureControl_int*) ssGetInputPortSignal(S,0);
