...
extern int MCSendFindhome(unsigned int _canch, unsigned int _bno,  unsigned int _mch);
extern int MCJointENCZero(unsigned int _canch, unsigned int _bno,  unsigned int _mch);
extern int MCSendPWMZero(unsigned int _canch, unsigned int _bno,  unsigned int _mch);
extern int MCLoadCellsensorNull(unsigned int _canch, unsigned int _bno);

extern int MCJointSetControlMode(unsigned int _canch, unsigned int _bno, unsigned int _mch, int _mode);
