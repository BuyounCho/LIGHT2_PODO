...
//    void UpdateSettings();
    ...
    void on_BTN_SHOW_CURRENT_PARA_clicked();

    void on_BTN_BOARD_TEST_ERRORRESET_clicked();

    void on_BTN_SET_BNO_clicked();

    void on_BTN_FET_ONOFF_2_clicked();
