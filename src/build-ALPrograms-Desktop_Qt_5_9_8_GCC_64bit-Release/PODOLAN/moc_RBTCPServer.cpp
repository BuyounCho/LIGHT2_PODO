...
void RBTCPServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RBTCPServer::SIG_NewConnection)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (RBTCPServer::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RBTCPServer::SIG_DisConnected)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject RBTCPServer::staticMetaObject = {
    { &QTcpServer::staticMetaObject, qt_meta_stringdata_RBTCPServer.data,
      qt_meta_data_RBTCPServer,  qt_static_metacall, nullptr, nullptr}
};
