...
public:
    ...
    void Generate_CPandZMP_BasicPattern(int _N_Prev, double _dT_Prev,
                                        Vector3d *_CPref_horizon, Vector3d *_ZMPref_horizon);
    ...
    bool GenerateWalkingPattern_Formulation(Vector3d Xref_CoM, Vector3d dXref_CoM, Vector3d u_CoM, Vector3d u_dCoM, Vector3d u_ddCoM);
    ...
    LIGHTWholeMotions() {
        ...
        Freq_body_pos_DSP = Vector3d::Ones()*0.50;
        Freq_body_ori_DSP = Vector3d::Ones()*1.10;
        Freq_foot_pos_DSP = Vector3d::Ones()*0.25;
        Freq_foot_ori_DSP = Vector3d::Ones()*0.25;
        Zeta_body_pos_DSP = Vector3d::Ones()*0.50;
        Zeta_body_ori_DSP = Vector3d::Ones()*0.50;
        Zeta_foot_pos_DSP = Vector3d::Ones()*0.50;
        Zeta_foot_ori_DSP = Vector3d::Ones()*0.50;

        WeightCompensation_RSSP = 1.00;
        Freq_body_pos_RSSP = Vector3d::Ones()*0.50;
        Freq_body_ori_RSSP = Vector3d::Ones()*1.10;
        Freq_foot_pos_RSSP = Vector3d::Ones()*1.50;
        Freq_foot_ori_RSSP = Vector3d::Ones()*1.50;
