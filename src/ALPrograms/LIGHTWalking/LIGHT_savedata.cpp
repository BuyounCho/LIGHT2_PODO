...
void save_File(char *filecomment)
{
    ...
    std::stringstream ss;
    ss << std::put_time(std::localtime(&in_time_t), "LIGHT_AL_Data/%Y%m%d_%X");
...
void save_PutData(unsigned int cur_Index)
{
    ...
    save_Buf[3][cur_Index] = sharedSEN->ENCODER[RHR][0].CurrentRefActVel;
    ...
    save_Buf[8][cur_Index] = sharedSEN->ENCODER[RHY][0].CurrentRefActVel;
    ...
    save_Buf[16][cur_Index] = sharedSEN->ENCODER[RHP][0].CurrentRefActVel;
    ...
    save_Buf[26][cur_Index] = sharedSEN->ENCODER[RKN][0].CurrentRefActVel;
    ...
    save_Buf[36][cur_Index] = sharedSEN->ENCODER[RAP][0].CurrentRefActVel;
    ...
    save_Buf[46][cur_Index] = sharedSEN->ENCODER[RAR][0].CurrentRefActVel;
    ...
    save_Buf[66][cur_Index] = sharedSEN->ENCODER[LHP][0].CurrentRefActVel;
    ...
    save_Buf[76][cur_Index] = sharedSEN->ENCODER[LKN][0].CurrentRefActVel;
    ...
    save_Buf[86][cur_Index] = sharedSEN->ENCODER[LAP][0].CurrentRefActVel;
    ...
    save_Buf[96][cur_Index] = sharedSEN->ENCODER[LAR][0].CurrentRefActVel;
    ...
    save_Buf[171][cur_Index] = sharedREF->LoadPressureReference_Future[0][0];
    save_Buf[172][cur_Index] = sharedREF->LoadPressureReference_Future[0][1];
    save_Buf[173][cur_Index] = sharedREF->LoadPressureReference_Future[0][2];
    save_Buf[174][cur_Index] = sharedREF->LoadPressureReference_Future[0][3];
    save_Buf[175][cur_Index] = sharedREF->LoadPressureReference_Future[0][4];
    save_Buf[176][cur_Index] = sharedREF->LoadPressureReference_Future[0][5];
    save_Buf[177][cur_Index] = sharedREF->LoadPressureReference_Future[0][6];
    save_Buf[178][cur_Index] = sharedREF->LoadPressureReference_Future[0][7];
    save_Buf[179][cur_Index] = sharedREF->LoadPressureReference_Future[0][8];
    save_Buf[180][cur_Index] = sharedREF->LoadPressureReference_Future[0][9];
    save_Buf[181][cur_Index] = sharedREF->LoadPressureReference_Future[0][10];
    save_Buf[182][cur_Index] = sharedREF->LoadPressureReference_Future[0][11];
...
void save_File_SupPres()
{
    ...
    std::stringstream ss;
    ss << std::put_time(std::localtime(&in_time_t), "LIGHT_FullScenarioTask_Data/%Y%m%d_%X");
    string filedate_s = ss.str();
    filedate_s.erase(filedate_s.end()-6);
    filedate_s.erase(filedate_s.end()-3);
    const char* filedate = filedate_s.c_str();
...
//    char file_name[60] = "LIGHT_CoM_SYS_ID_Data_";
...
void save_File_TuningParameters()
{
    ...
    std::stringstream ss;
    ss << std::put_time(std::localtime(&in_time_t), "LIGHT_AL_Data/TuningParameters/%Y%m%d_%X");
    string filedate_s = ss.str();
    filedate_s.erase(filedate_s.end()-6);
    filedate_s.erase(filedate_s.end()-3);
    const char* filedate = filedate_s.c_str();
