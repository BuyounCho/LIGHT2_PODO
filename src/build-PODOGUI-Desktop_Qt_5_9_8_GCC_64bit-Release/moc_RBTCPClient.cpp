...
void RBTCPClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RBTCPClient::SIG_Connected)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (RBTCPClient::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RBTCPClient::SIG_Disconnected)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject RBTCPClient::staticMetaObject = {
    { &QTcpSocket::staticMetaObject, qt_meta_stringdata_RBTCPClient.data,
      qt_meta_data_RBTCPClient,  qt_static_metacall, nullptr, nullptr}
};
