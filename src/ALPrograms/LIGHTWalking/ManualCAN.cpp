...
int MCSendFindhome(unsigned int _canch, unsigned int _bno,  unsigned int _mch);
int MCJointENCZero(unsigned int _canch, unsigned int _bno,  unsigned int _mch);
//int MCSendPWMZero(unsigned int _canch, unsigned int _bno,  unsigned int _mch);
