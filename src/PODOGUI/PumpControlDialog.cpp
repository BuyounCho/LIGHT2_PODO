...
{
    USER_COMMAND cmd;
    cmd.COMMAND_DATA.USER_PARA_INT[0] = 188;
...
{
    USER_COMMAND cmd;
    cmd.COMMAND_DATA.USER_PARA_INT[0] = 190;
...
{
    USER_COMMAND cmd;
    cmd.COMMAND_DATA.USER_PARA_INT[0] = 182;
    cmd.COMMAND_DATA.USER_COMMAND = DAEMON4LIGHT_PUMP_SEND_COMMAND;
...
{
    USER_COMMAND cmd;
    cmd.COMMAND_DATA.USER_PARA_INT[0] = 183;
    cmd.COMMAND_DATA.USER_COMMAND = DAEMON4LIGHT_PUMP_SEND_COMMAND;
    cmd.COMMAND_TARGET = RBCORE_PODO_NO;
    pLAN->SendCommand(cmd);
}
...
void PumpControlDialog::on_BTN_TORQUEFORCE_NULLING_clicked()
{
    USER_COMMAND cmd;
