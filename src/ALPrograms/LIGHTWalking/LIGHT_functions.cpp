                           ...
                           MatrixNd& _A, VectorNd& _B)
{
    ...
    double ZMPx_RF_min = -LIGHT_Info.limit_heel;
    double ZMPx_RF_max = LIGHT_Info.limit_toe;
    double ZMPy_RF_min = -LIGHT_Info.limit_outside;
    double ZMPy_RF_max = LIGHT_Info.limit_inside;
    double ZMPx_LF_min = -LIGHT_Info.limit_heel;
    double ZMPx_LF_max = LIGHT_Info.limit_toe;
    double ZMPy_LF_min = -LIGHT_Info.limit_inside;
    double ZMPy_LF_max = LIGHT_Info.limit_outside;
...
double LPF_1st(double x_old, double x_new, double f_cut)
{
    double alpha = 1.0/(1.0+SYS_FREQ/(2.0*PI*f_cut));
