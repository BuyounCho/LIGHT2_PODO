...
bool FETOnOff = false;
void HCBSettingDialog::on_BTN_FET_ONOFF_clicked()
{
    // FET on/off
    if(ui->BTN_FET_ONOFF->text() == "All FET Enable"){
        FETOnOff = true;
        ui->BTN_FET_ONOFF->setText("All FET Disable");
    }else{
        FETOnOff = false;
        ui->BTN_FET_ONOFF->setText("All FET Enable");
    }

    USER_COMMAND cmd;
    cmd.COMMAND_DATA.USER_PARA_CHAR[0] = -1; // Command to all joints
    cmd.COMMAND_DATA.USER_PARA_CHAR[1] = 0;
    cmd.COMMAND_DATA.USER_PARA_CHAR[2] = FETOnOff;
    cmd.COMMAND_DATA.USER_COMMAND = DAEMON4LIGHT_MOTION_FET_ONOFF;
    cmd.COMMAND_TARGET = RBCORE_PODO_NO;
    pLAN->SendCommand(cmd);
}
...
void HCBSettingDialog::on_BTN_ENC_ENABLE_clicked()
{
    ...
    cmd.COMMAND_DATA.USER_COMMAND = DAEMON4LIGHT_MOTION_REQUEST_ENABLE_DISABLE;
    cmd.COMMAND_TARGET = RBCORE_PODO_NO;
    pLAN->SendCommand(cmd);
}
...
void HCBSettingDialog::on_BTN_ASK_EVERYTHING_clicked()
{
    ...
    cmd.COMMAND_DATA.USER_COMMAND = DAEMON4LIGHT_MOTION_ASK_EVERYTHING;
    cmd.COMMAND_TARGET = RBCORE_PODO_NO;
    pLAN->SendCommand(cmd);
}
...
void HCBSettingDialog::on_BTN_PARAMETER_SET_ALL_clicked()
{
    ...
    cmd.COMMAND_DATA.USER_COMMAND = DAEMON4LIGHT_MOTION_SET_EVERYTHING;
    HCB_INFO HCB_Info;
    ...
    HCB_Info.VALVE_P_KP                  = ui->LE_200->text().toInt();
    HCB_Info.VALVE_P_KI                  = ui->LE_201->text().toInt();
    HCB_Info.VALVE_P_KD                  = ui->LE_202->text().toInt();

    HCB_Info.JOINT_P_KP                  = ui->LE_300->text().toInt();
    HCB_Info.JOINT_P_KI                  = ui->LE_301->text().toInt();
    HCB_Info.JOINT_P_KD                  = ui->LE_302->text().toInt();

    HCB_Info.JOINT_F_KP                  = ui->LE_400->text().toInt();
    HCB_Info.JOINT_F_KI                  = ui->LE_401->text().toInt();
    HCB_Info.JOINT_F_KD                  = ui->LE_402->text().toInt();
...
void HCBSettingDialog::on_BTN_SHOW_CURRENT_PARA_clicked()
{
    int BNO = GetSelected();
    ...
    ui->LE_200->setText(QString().sprintf("%d",PODO_DATA.CoreSEN.ENCODER[BNO][0].HCB_Info.VALVE_P_KP));
    ui->LE_201->setText(QString().sprintf("%d",PODO_DATA.CoreSEN.ENCODER[BNO][0].HCB_Info.VALVE_P_KI));
    ui->LE_202->setText(QString().sprintf("%d",PODO_DATA.CoreSEN.ENCODER[BNO][0].HCB_Info.VALVE_P_KD));

    ui->LE_300->setText(QString().sprintf("%d",PODO_DATA.CoreSEN.ENCODER[BNO][0].HCB_Info.JOINT_P_KP));
    ui->LE_301->setText(QString().sprintf("%d",PODO_DATA.CoreSEN.ENCODER[BNO][0].HCB_Info.JOINT_P_KI));
    ui->LE_302->setText(QString().sprintf("%d",PODO_DATA.CoreSEN.ENCODER[BNO][0].HCB_Info.JOINT_P_KD));

    ui->LE_400->setText(QString().sprintf("%d",PODO_DATA.CoreSEN.ENCODER[BNO][0].HCB_Info.JOINT_F_KP));
    ui->LE_401->setText(QString().sprintf("%d",PODO_DATA.CoreSEN.ENCODER[BNO][0].HCB_Info.JOINT_F_KI));
    ui->LE_402->setText(QString().sprintf("%d",PODO_DATA.CoreSEN.ENCODER[BNO][0].HCB_Info.JOINT_F_KD));
...
{
    USER_COMMAND cmd;
    cmd.COMMAND_DATA.USER_COMMAND = DAEMON4LIGHT_MOTION_BOARDTEST_ERRORRESET;
    cmd.COMMAND_TARGET = RBCORE_PODO_NO;
    pLAN->SendCommand(cmd);
}
...
void HCBSettingDialog::on_BTN_FET_ONOFF_2_clicked()
{
    USER_COMMAND cmd;
    cmd.COMMAND_DATA.USER_COMMAND = DAEMON4LIGHT_INIT_CAN_RESET;
    cmd.COMMAND_TARGET = RBCORE_PODO_NO;
    pLAN->SendCommand(cmd);
...
void HCBSettingDialog::on_BTN_PRESSURE_NULLING_clicked()
{
    USER_COMMAND cmd;
    cmd.COMMAND_DATA.USER_PARA_CHAR[0] = -1; // Command to selected joint
    cmd.COMMAND_DATA.USER_COMMAND = DAEMON4LIGHT_MOTION_PRES_NULLING;
    cmd.COMMAND_TARGET = RBCORE_PODO_NO;
    pLAN->SendCommand(cmd);
}
...
void HCBSettingDialog::on_BTN_PRESSURE_NULLING_ONE_clicked()
{
    USER_COMMAND cmd;
    cmd.COMMAND_DATA.USER_PARA_CHAR[0] = GetSelected(); // Command to selected joint
    cmd.COMMAND_DATA.USER_COMMAND = DAEMON4LIGHT_MOTION_PRES_NULLING;
