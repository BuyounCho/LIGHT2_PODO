...
void LANDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LANDialog::NewPODOData)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (LANDialog::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LANDialog::SIG_LAN_HIDE)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LANDialog::SIG_LAN_ON_OFF)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject LANDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_LANDialog.data,
      qt_meta_data_LANDialog,  qt_static_metacall, nullptr, nullptr}
};
...
const QMetaObject PODOClient::staticMetaObject = {
    { &RBTCPClient::staticMetaObject, qt_meta_stringdata_PODOClient.data,
      qt_meta_data_PODOClient,  qt_static_metacall, nullptr, nullptr}
};
