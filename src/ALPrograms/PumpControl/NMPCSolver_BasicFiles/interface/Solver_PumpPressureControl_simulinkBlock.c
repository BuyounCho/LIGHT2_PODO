...
#define S_FUNCTION_NAME Solver_PumpPressureControl_simulinkBlock
...
typedef Solver_PumpPressureControlinterface_float Solver_PumpPressureControlnmpc_float;

extern void Solver_PumpPressureControl_casadi2forces(double *x, double *y, double *l, double *p, double *f, double *nabla_f, double *c, double *nabla_c, double *h, double *nabla_h, double *hess, solver_int32_default stage, solver_int32_default iteration, solver_int32_default threadID);
...
static void mdlInitializeSizes(SimStruct *S)
{
	...
	/* Input Port 1 */
    ssSetInputPortMatrixDimensions(S,  1, 48, 1);
    ssSetInputPortDataType(S, 1, SS_DOUBLE);
    ssSetInputPortComplexSignal(S, 1, COMPLEX_NO); /* no complex signals suppported */
    ssSetInputPortDirectFeedThrough(S, 1, 1); /* Feedthrough enabled */
    ssSetInputPortRequiredContiguous(S, 1, 1); /*direct input signal access*/	
	/* Input Port 2 */
    ssSetInputPortMatrixDimensions(S,  2, 16, 1);
	...
	/* initialize output ports - there are 16 in total */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
	...
	const Solver_PumpPressureControl_int *reinitialize = (const Solver_PumpPressureControl_int*) ssGetInputPortSignal(S,3);
