...
//        if(_RefFrame == LIGHT.REFFRAME_LF)
        ...
        W_temp = 1.0;
        temp_size_cost = LIGHT_ACT_DOF-2;
        Resize_TempMatrix(temp_size_cost,n_var,A_temp,B_temp);

        A_temp(0,idx_JntTorque+RHR) = 1e-4;
        A_temp(1,idx_JntTorque+LHR) = 1e-4;
        A_temp(2,idx_JntTorque+RHY) = 1e-4;
        A_temp(3,idx_JntTorque+LHY) = 1e-4;
        A_temp(4,idx_JntTorque+RHP) = 1e-4;
        A_temp(5,idx_JntTorque+LHP) = 1e-4;
        A_temp(6,idx_JntTorque+RAP) = 1e-3;
        A_temp(7,idx_JntTorque+LAP) = 1e-3;
        A_temp(8,idx_JntTorque+RAR) = 1e-3;
        A_temp(9,idx_JntTorque+LAR) = 1e-3;
        A_temp(10,idx_JntTorque+WST) = 1.0;
//        A_temp(6,idx_JntTorque+RKN) = 1e-9;
//        A_temp(7,idx_JntTorque+LKN) = 1e-9;
...
//        A_temp(0,idx_ddQ+FLOATING_BASE_DOF+RHR) = 3e-3;
//        A_temp(1,idx_ddQ+FLOATING_BASE_DOF+LHR) = 3e-3;
//        A_temp(2,idx_ddQ+FLOATING_BASE_DOF+RHY) = 3e-3;
//        A_temp(3,idx_ddQ+FLOATING_BASE_DOF+LHY) = 3e-3;
//        A_temp(4,idx_ddQ+FLOATING_BASE_DOF+RHP) = 3e-3;
//        A_temp(5,idx_ddQ+FLOATING_BASE_DOF+LHP) = 3e-3;
//        A_temp(6,idx_ddQ+FLOATING_BASE_DOF+RKN) = 3e-3;
//        A_temp(7,idx_ddQ+FLOATING_BASE_DOF+LKN) = 3e-3;
//        A_temp(8,idx_ddQ+FLOATING_BASE_DOF+RAP) = 3e-3;
//        A_temp(9,idx_ddQ+FLOATING_BASE_DOF+LAP) = 3e-3;
//        A_temp(10,idx_ddQ+FLOATING_BASE_DOF+RAR) = 3e-3;
//        A_temp(11,idx_ddQ+FLOATING_BASE_DOF+LAR) = 3e-3;
//        A_temp(12,idx_ddQ+FLOATING_BASE_DOF+WST) = 10.0;
//        B_temp.block(0,0,temp_size_cost,1) = VectorNd::Zero(temp_size_cost);

//        Matrix4QP_Addition(A_cost,B_cost,W_temp*A_temp,W_temp*B_temp);
//        idx_cost += temp_size_cost;

//        // 6. External Force/Torque Minimization
//        W_temp = 1.0;
//        temp_size_cost = 2;
//        Resize_TempMatrix(temp_size_cost,n_var,A_temp,B_temp);

////        A_temp(0,idx_Ext_RF+0) = 1e-3; // Torque
////        A_temp(1,idx_Ext_RF+1) = 1e-3;
////        A_temp(2,idx_Ext_RF+2) = 1e-2;
////        A_temp(0,idx_Ext_RF+3) = 1e-2; // Force
////        A_temp(1,idx_Ext_RF+4) = 1e-2;
//        A_temp(0,idx_Ext_RF+5) = 1e-3;
////        A_temp(6,idx_Ext_LF+0) = 1e-3; // Torque
////        A_temp(7,idx_Ext_LF+1) = 1e-3;
////        A_temp(8,idx_Ext_LF+2) = 1e-2;
////        A_temp(3,idx_Ext_LF+3) = 1e-2; // Force
////        A_temp(4,idx_Ext_LF+4) = 1e-2;
//        A_temp(1,idx_Ext_LF+5) = 1e-3;
//        B_temp.block(0,0,temp_size_cost,1) = VectorNd::Zero(temp_size_cost);

//        Matrix4QP_Addition(A_cost,B_cost,W_temp*A_temp,W_temp*B_temp);
//        idx_cost += temp_size_cost;

        // 6-2. External Force Distribution
        W_temp = 2e-3;
        temp_size_cost = 2;
        Resize_TempMatrix(temp_size_cost,n_var,A_temp,B_temp);

        A_temp(0,idx_Ext_RF+5) = 1.0;
        A_temp(1,idx_Ext_LF+5) = 1.0;
        if(_RefFrame == LIGHT.REFFRAME_RF) {
            ...
            B_temp(0) = (1.0-alpha)*m*g_const; // RFz
            B_temp(1) = alpha*m*g_const; // LFz
        } else {
            Vector3d Step = LIGHT.Xnow_LF2RF;
            Vector3d CoM = LIGHT.Xnow_LF2CoM;
            double m = LIGHT.LIGHT_Info->m_robot;
            double alpha = Step.dot(CoM)/Step.dot(Step);
            B_temp(0) = alpha*m*g_const; // RFz
            B_temp(1) = (1.0-alpha)*m*g_const; // LFz
        }
        Matrix4QP_Addition(A_cost,B_cost,W_temp*A_temp,W_temp*B_temp);
        idx_cost += temp_size_cost;

        // 7. Stance Legs Force Equalization (1) /////////////////////////////////////////////////////////////////////
        {
            W_temp = 1.0;
            temp_size_cost = 3;
            Resize_TempMatrix(temp_size_cost,n_var,A_temp,B_temp);

            A_temp(0,idx_Ext_RF+0) = 5e-2;
            A_temp(1,idx_Ext_RF+1) = 5e-2;
            A_temp(2,idx_Ext_RF+2) = 5e-2;
//            A_temp(3,idx_Ext_RF+3) = 1e-5;
//            A_temp(4,idx_Ext_RF+4) = 1e-5;
//            A_temp(5,idx_Ext_RF+5) = 1e-5;

            A_temp(0,idx_Ext_LF+0) = -5e-2;
            A_temp(1,idx_Ext_LF+1) = -5e-2;
            A_temp(2,idx_Ext_LF+2) = -5e-2;
//            A_temp(3,idx_Ext_LF+3) = -1e-5;
//            A_temp(4,idx_Ext_LF+4) = -1e-5;
//            A_temp(5,idx_Ext_LF+5) = -1e-5;
...
//        // 9-1. CoM Height Stabilization by Z-direction Force (1) /////////////////////////////////////////////////////////////////////
//        // Fz_RF + Fz_LF = Mg + K*HeightComp;
//        {
//            W_temp = 0.00001;
//            temp_size_cost = 1;
//            Resize_TempMatrix(temp_size_cost,n_var,A_temp,B_temp);

//            double Fz_ref = WeightCompensation_DSP*LIGHT.m_robot*g_const + 1.0*CoMHeightControl(500.0, 500.0, 0.0);

//            A_temp(0,idx_Ext_RF+5) = 1.0;
//            A_temp(0,idx_Ext_LF+5) = 1.0;
//            B_temp(0) = Fz_ref;
...
//        std::cout << "The rank of A is " << lu_decomp.rank() << std::endl;
        ...
        // ZMP Constraints *************************
        double ZMPx_RF_min = -LIGHT.LIGHT_Info->limit_heel;
        double ZMPx_RF_max = LIGHT.LIGHT_Info->limit_toe;
        double ZMPy_RF_min = -LIGHT.LIGHT_Info->limit_outside;
        double ZMPy_RF_max = LIGHT.LIGHT_Info->limit_inside;
        double ZMPx_LF_min = -LIGHT.LIGHT_Info->limit_heel;
        double ZMPx_LF_max = LIGHT.LIGHT_Info->limit_toe;
        double ZMPy_LF_min = -LIGHT.LIGHT_Info->limit_inside;
        double ZMPy_LF_max = LIGHT.LIGHT_Info->limit_outside;
...
//    LIGHT.ContactOff_LF();
    ...
    if (QPSolver_On) {
        ...
        // 1. Pelvis Orientation(3) //////////////////////////////////////////////////////////////////////
        {
            ...
            Wn(2,2) = 2.0*PI*Freq_body_ori_RSSP(2);
            Vector3d dW_ref = LIGHT.dWdes_Pel
                    + 2.0*Zeta*Wn*(LIGHT.Wdes_Pel-LIGHT.Wnow_Pel)
                    + Wn*Wn*OrientationError(LIGHT.Rdes_Pel,LIGHT.Rnow_Pel);
        ...
        // 3. LF Orientation(3) //////////////////////////////////////////////////////////////////////
        {
            ...
            Wn(2,2) = 2.0*PI*Freq_foot_ori_RSSP(2);
...
//        A_temp(4,idx_JntTorque+RHP) = 1e-4;
//        A_temp(5,idx_JntTorque+LHP) = 1e-4;
//        A_temp(6,idx_JntTorque+RAP) = 1e-4;
//        A_temp(7,idx_JntTorque+LAP) = 1e-4;
//        A_temp(8,idx_JntTorque+RAR) = 1e-4;
//        A_temp(9,idx_JntTorque+LAR) = 1e-4;
//        A_temp(10,idx_JntTorque+WST) = 1.0;
//        B_temp.block(0,0,temp_size_cost,1) = VectorNd::Zero(temp_size_cost);
...
//        idx_cost += temp_size_cost;
        ...
        // 6. Acceleration Minimization ///////////////////////////////////////
        W_temp = 1.0;
        temp_size_cost = LIGHT_ACT_DOF;
        Resize_TempMatrix(temp_size_cost,n_var,A_temp,B_temp);

        A_temp(0,idx_ddQ+FLOATING_BASE_DOF+RHR) = 1e-5;
        A_temp(1,idx_ddQ+FLOATING_BASE_DOF+LHR) = 1e-5;
        A_temp(2,idx_ddQ+FLOATING_BASE_DOF+RHY) = 1e-5;
        A_temp(3,idx_ddQ+FLOATING_BASE_DOF+LHY) = 1e-5;
        A_temp(4,idx_ddQ+FLOATING_BASE_DOF+RHP) = 1e-5;
        A_temp(5,idx_ddQ+FLOATING_BASE_DOF+LHP) = 1e-5;
        A_temp(6,idx_ddQ+FLOATING_BASE_DOF+RKN) = 1e-5;
        A_temp(7,idx_ddQ+FLOATING_BASE_DOF+LKN) = 1e-5;
        A_temp(8,idx_ddQ+FLOATING_BASE_DOF+RAP) = 1e-5;
        A_temp(9,idx_ddQ+FLOATING_BASE_DOF+LAP) = 1e-5;
        A_temp(10,idx_ddQ+FLOATING_BASE_DOF+RAR) = 1e-5;
        A_temp(11,idx_ddQ+FLOATING_BASE_DOF+LAR) = 1e-5;
        A_temp(12,idx_ddQ+FLOATING_BASE_DOF+WST) = 10.0;
        B_temp.block(0,0,temp_size_cost,1) = VectorNd::Zero(temp_size_cost);
...
//        A_temp(0,idx_Ext_RF+0) = 1e-3;
//        A_temp(1,idx_Ext_RF+1) = 1e-3;
//        A_temp(2,idx_Ext_RF+2) = 1e-2;
//        A_temp(3,idx_Ext_RF+3) = 1e-4;
//        A_temp(4,idx_Ext_RF+4) = 1e-4;
//        A_temp(5,idx_Ext_RF+5) = 1e-5;
...
//        A_temp(0,idx_Ext_LF+0) = 1e-3;
//        A_temp(1,idx_Ext_LF+1) = 1e-3;
//        A_temp(2,idx_Ext_LF+2) = 1e-2;
//        A_temp(3,idx_Ext_LF+3) = 1e-4;
//        A_temp(4,idx_Ext_LF+4) = 1e-4;
//        A_temp(5,idx_Ext_LF+5) = 1e-5;
...
//    LIGHT.ContactOff_LF();
    ...
    if (QPSolver_On) {
        ...
        A_temp(0,idx_ddQ+FLOATING_BASE_DOF+WST) = 1.0;
...
//        idx_cost += temp_size_cost;
        ...
        ///  So, the solution must satisfy EoM  >>>  "Equality Constraint"
        ///
        ///  M(Q)*ddQ + C(Q,dQ) + G(Q) = S*Tau
        ///                                 L Joint Torque
        ///  >> [M(Q) -S]*[ddQ;Tau] = -C(Q,dQ) - G(Q)
        ///
        /////////////////////////////////////////////////////////////////////////////////////////////////
