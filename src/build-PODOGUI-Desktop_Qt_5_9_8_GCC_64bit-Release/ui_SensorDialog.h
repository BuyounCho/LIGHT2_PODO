...
public:
    ...
    QPushButton *BTN_NEW_IMU_DISABLE;
    QPushButton *BTN_FT_NULLING;
    QPushButton *BTN_FT_DISABLE;
    QPushButton *BTN_FT_ENABLE;
    QLabel *label;
    QFrame *line;
...
""));
        ...
        BTN_NEW_IMU_ENABLE->setGeometry(QRect(140, 200, 71, 21));
        BTN_NEW_IMU_NULL = new QPushButton(groupBox);
        BTN_NEW_IMU_NULL->setObjectName(QStringLiteral("BTN_NEW_IMU_NULL"));
        BTN_NEW_IMU_NULL->setGeometry(QRect(300, 200, 71, 21));
        BTN_NEW_IMU_RESET = new QPushButton(groupBox);
        BTN_NEW_IMU_RESET->setObjectName(QStringLiteral("BTN_NEW_IMU_RESET"));
        BTN_NEW_IMU_RESET->setGeometry(QRect(380, 200, 81, 21));
        BTN_NEW_IMU_DISABLE = new QPushButton(groupBox);
        BTN_NEW_IMU_DISABLE->setObjectName(QStringLiteral("BTN_NEW_IMU_DISABLE"));
        BTN_NEW_IMU_DISABLE->setGeometry(QRect(220, 200, 71, 21));
        BTN_FT_NULLING = new QPushButton(groupBox);
        BTN_FT_NULLING->setObjectName(QStringLiteral("BTN_FT_NULLING"));
        BTN_FT_NULLING->setEnabled(true);
        BTN_FT_NULLING->setGeometry(QRect(300, 30, 70, 21));
        BTN_FT_DISABLE = new QPushButton(groupBox);
        BTN_FT_DISABLE->setObjectName(QStringLiteral("BTN_FT_DISABLE"));
        BTN_FT_DISABLE->setGeometry(QRect(220, 30, 70, 21));
        BTN_FT_ENABLE = new QPushButton(groupBox);
        BTN_FT_ENABLE->setObjectName(QStringLiteral("BTN_FT_ENABLE"));
        BTN_FT_ENABLE->setGeometry(QRect(140, 30, 70, 21));
        ...
        BTN_SENSOR_FT_NULL->setEnabled(false);
        ...
        BTN_SENSOR_IMU_NULL->setEnabled(false);
        ...
        BTN_SENSOR_ENABLE->setEnabled(false);
        ...
        BTN_SENSOR_DISABLE->setEnabled(false);
    ...
    void retranslateUi(QDialog *SensorDialog)
    {
        ...
        label_59->setText(QApplication::translate("SensorDialog", "FOG Roll", Q_NULLPTR));
        label_40->setText(QApplication::translate("SensorDialog", "FOG Pitch", Q_NULLPTR));
        label_41->setText(QApplication::translate("SensorDialog", "FOG Yaw", Q_NULLPTR));
        BTN_SENSOR_FOG_NULL->setText(QApplication::translate("SensorDialog", "FOG NULL", Q_NULLPTR));
        BTN_SENSOR_FOG_ZERO->setText(QApplication::translate("SensorDialog", "FOG ZERO", Q_NULLPTR));
        label_64->setText(QApplication::translate("SensorDialog", "FOG", Q_NULLPTR));
        ...
        label_2->setText(QApplication::translate("SensorDialog", "Left Leg", Q_NULLPTR));
        label_3->setText(QApplication::translate("SensorDialog", "Right Leg", Q_NULLPTR));
        BTN_OPTZERO->setText(QApplication::translate("SensorDialog", "Opt Zero", Q_NULLPTR));
        label_66->setText(QApplication::translate("SensorDialog", "Optic Flow", Q_NULLPTR));
        BTN_OPT_LAMP_ON->setText(QApplication::translate("SensorDialog", "Lamp On", Q_NULLPTR));
        BTN_OPT_LAMP_OFF->setText(QApplication::translate("SensorDialog", "Lamp Off", Q_NULLPTR));
        BTN_SENSOR_FOG_USB_RESET->setText(QApplication::translate("SensorDialog", "USB RST", Q_NULLPTR));
        BTN_NEW_IMU_ENABLE->setText(QApplication::translate("SensorDialog", "Enable", Q_NULLPTR));
        BTN_NEW_IMU_NULL->setText(QApplication::translate("SensorDialog", "Null", Q_NULLPTR));
        BTN_NEW_IMU_RESET->setText(QApplication::translate("SensorDialog", "Reset", Q_NULLPTR));
        BTN_NEW_IMU_DISABLE->setText(QApplication::translate("SensorDialog", "Disable", Q_NULLPTR));
        BTN_FT_NULLING->setText(QApplication::translate("SensorDialog", "Null", Q_NULLPTR));
        BTN_FT_DISABLE->setText(QApplication::translate("SensorDialog", "Disable", Q_NULLPTR));
        BTN_FT_ENABLE->setText(QApplication::translate("SensorDialog", "Enable", Q_NULLPTR));
